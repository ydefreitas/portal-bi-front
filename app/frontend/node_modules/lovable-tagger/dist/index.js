...
function createTailwindConfigFeature() {
	...
	return {
		...
		onConfigureServer(server) {
			try {
				const watchPaths = [path.resolve(projectRoot, "./tailwind.config.ts"), ...V4_CSS_CANDIDATES.map((c) => path.resolve(projectRoot, c))];
...
//#endregion
export { lovableTagger as componentTagger };
