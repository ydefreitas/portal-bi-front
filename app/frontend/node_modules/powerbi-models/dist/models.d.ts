...
export declare type IFilterGeneralTarget = IFilterTarget | IFilterKeyTarget | ITupleFilterTarget | IIdentityFilterTarget | IIncludeExcludeFilterTarget | IHierarchyIdentityFilterTarget;
...
export declare class HierarchyIdentityFilter<IdentityType> extends Filter {
    static schemaUrl: string;
    target: IHierarchyIdentityFilterTarget;
    hierarchyData: IHierarchyIdentityFilterNode<IdentityType>[];
    constructor(target: IHierarchyIdentityFilterTarget, hierarchyData: IHierarchyIdentityFilterNode<IdentityType>[]);
...
export declare function isVisualCalculation(arg: any): arg is IVisualCalculationTarget;
...
export declare enum ExportDataResultType {
    Summarized = 0,
    Underlying = 1,
    DataWithCurrentLayout = 2
}
export declare enum ExportDataResultFormat {
    Csv = 0,
    Xlsx = 1
}
export declare enum ExportDataCompletedStatus {
    Succeeded = 0,
    Failed = 1
}
