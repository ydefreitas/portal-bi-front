/*! window-post-message-proxy v0.3.0 | (c) 2016 Microsoft Corporation MIT */
declare global {
    interface Window {
        msCrypto: Crypto;
    }
...
export interface IWindowPostMessageProxyOptions {
    ...
    eventOriginOverride?: string;
    suppressWarnings?: boolean;
    receivedMessageValidation?: IMessageValidation;
}
export declare class WindowPostMessageProxy {
    ...
    private eventOriginOverride;
    private suppressWarnings;
    private receivedMessageValidation;
     ...
     */
    postMessage<T>(targetWindow: Window, message: any, targetOrigin?: string): Promise<T>;
    /**
    ...
    /**
     * Checks if the received message is valid according to configured validation rules.
     */
    private isReceivedMessageValid;
    /**
     * Message handler.
     */
